...
import logo_boomslag from 'assets/img/pngwing.com.png'
    ...
    return(
        ...
        <div className="mx-auto max-w-full py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
          ...
          <div className="mt-12 border-t border-gray-200 pt-8">
            <p className="text-base text-gray-400 xl:text-center">&copy; 2023 Lego by Double-R, Inc. All rights reserved.</p>
          </div>
        </div>
      </footer>
    )
